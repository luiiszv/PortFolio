  ...
  <VerticalTimelineElement
    ...
    icon={
      <div className='flex justify-center items-center w-full h-full'>
        <img src={experience.icon} alt={experience.comany_name} className='w-[60%] h-[60%] object-contain' />
      </div>
    }
  >
  ...
  return (
    <>
      ...
      <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText}`}>Lo que he logrado hasta ahora</p>
      ...
      <div className="mt-20 flex flex-col">
        <VerticalTimeline>
          {experiencia.map((exp, index) => ( // Cambiado a exp
            <ExperienceCard
              key={index}
              experience={exp} // Cambiado a exp
            />
          ))}
        </VerticalTimeline>
      </div>
